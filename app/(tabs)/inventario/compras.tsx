...
import { TextInput, Button, Text, Menu, useTheme } from 'react-native-paper';
...
export default function ComprasScreen() {
  ...
  const handleSubmit = useCallback(async () => {
    if (!selectedSupply) {
      Alert.alert('Error', 'Selecciona un insumo');
      return;
    }
    ...
    try {
      ...
      Alert.alert('Compra registrada', `${selectedSupply.name}: ${grams}g por ${formatCOP(priceCOP)}`);
  ...
  }, [selectedSupply, quantityGrams, priceCOP, supplier, paymentMethod, purchaseRepo]);
